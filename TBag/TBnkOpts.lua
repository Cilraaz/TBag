...
TBnk_Options_FRAME_HEIGHT = (TBnk_Options_FRAME_LINE_HEIGHT*(TBnk_OptS_SCROLL_LINES+1)) + (TBnk_Options_FRAME_BORDER*2) + TBnk_Options_FRAME_BOTTOMPADDING
...
function TBnkOpt_CreateCfgOpt()
  ...
  TBag:CreateCfgOpt(TBnk_CfgOpt, TBnkFrame.cfg, TBnkFrame.bags, function () TBnkFrame:UpdateWindow() end, TBnkOpt_ResizeUpdate, TBnkOpt_ForceUpdate)
...
function TBnk_Options_InitWindow()
    ...
    TBnk_Config_MaxScroll = mathmax( 1, (table.getn(TBnk_CfgOpt)-TBnk_OptS_SCROLL_LINES)+2 )
...
function TBnk_Options_UpdateWindow()
  ...
  local current_Opt = mathfloor(TBnk_Opts_CurrentPosition)
